...
% load('measure_NEMA_18.mat');
% load('measure_NEMA_36.mat');

load('measure_WI_3.mat'); %comp_type2 --- This one is the real white image for config: type2.
...
Ibp = iradon(Sm,(phideg-1/2*degstep),'None'); %or Shepp-Logan
Ibp =Ibp/max(Ibp(:));
